    ...
    <div class="auth-container">
        ...
        <div class="premium-card">
            <form id="login-form" class="auth-form active">
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display:block; font-size: 11px; font-weight: 700; text-transform: uppercase; color: var(--text-sub); margin-bottom: 8px;">Email Address</label>
                    <input type="email" name="email" class="modern-input" placeholder="Your email address" required>
                </div>
                <div style="margin-bottom: 20px;">
                ...
                <div style="margin-bottom: 30px;">
                    <label style="display:block; font-size: 11px; font-weight: 700; text-transform: uppercase; color: var(--text-sub); margin-bottom: 8px;">Starting Balance</label>
                    <input type="number" step="0.01" name="balance" class="modern-input" placeholder="0.00" required>
                </div>
